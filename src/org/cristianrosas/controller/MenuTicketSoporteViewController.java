...
public class MenuTicketSoporteViewController implements Initializable {
    ...
    // Vaciar todos los campos para poder agregar un nuevo evento
    ...
    // Cargar datos en los campos editar
    ...
    public void cargarCmbEstatus(){
     ...
     //Consulta sp_listarTicketsSoporte a la base de datos
    ...
    // consulta SP_listarTicketSoporte a la base de datos(Se utiliza para llenar el combobox de clientes)
